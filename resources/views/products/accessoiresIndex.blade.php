                ...
                <div class="filter">
                    ...
                    <div class="brand-selection">
                        ...
                        <div class="selection-group">
                            <label for="xxl-checkbox">Xxl Nutrition</label>
                            <input style="cursor: pointer;" id="xxl-checkbox" type="checkbox">
                        </div>
                        <div class="selection-group">
                            <label for="kosso-checkbox">Kosso Nutrition</label>
                            <input style="cursor: pointer;" id="kosso-checkbox" type="checkbox">
                        </div>
                        <div class="selection-group">
                            <label for="clean-checkbox">Clean Nutrition</label>
                            <input style="cursor: pointer;" id="clean-checkbox" type="checkbox">
                        </div>
                    </div>
